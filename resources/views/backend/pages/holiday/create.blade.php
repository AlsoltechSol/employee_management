        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.holidayMaster.store')}}" method="post" data-parsley-validate>
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" id="holiday_day" name="holiday_day"  required readonly>
                            ...
                            <div style="text-align:center;">
                                <button type="button" class="btn btn-primary  pr-4 pl-4" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-bookmark" aria-hidden="true"></i>&nbsp;Add Holiday Date</button>
                                <a class="btn btn-danger" href="{{route('admin.holidayMaster.index')}}"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Cancel </a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" >
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary"><i class="fa fa-bookmark" aria-hidden="true"></i>&nbsp;Add Holiday Date</button>
